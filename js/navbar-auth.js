// Centralized navbar authentication logic for login subfolder
// This script handles navbar visibility based on user authentication state
// Special version for login subfolder with different relative paths
...
function initNavbarAuth() {
    console.log('🔧 Initializing navbar authentication (login folder)...');
...
window.globalLogout = function() {
    ...
    signOut(auth).then(() => {
        ...
        // Stay on login page since we're already in login folder
